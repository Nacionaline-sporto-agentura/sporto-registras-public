...
class BEA
{
    ...
    public function __construct()
    {
        ...
        require_once BEA_DIR . 'classes/lib.class.php';
        require_once BEA_DIR . 'classes/i18n.class.php';
        require_once BEA_DIR . 'classes/minify.class.php';
        require_once BEA_DIR . 'classes/notifications.class.php';
        require_once BEA_DIR . 'classes/elementor.class.php';
        require_once BEA_DIR . 'classes/settings.class.php';
        ...
        $this->_classes = apply_filters(
            ...
            array(
                'lib'           => new BEA_Lib(),
                'notifications' => new BEA_Notifications(),
                'i18n'          => new BEA_i18n(),                
                'minify'        => new BEA_Minify(),
                'elementor'     => new BEA_Elementor(),
                'settings'      => new BEA_Settings(),
                'empty'         => new BEA_Empty()
            )
        );
    }
